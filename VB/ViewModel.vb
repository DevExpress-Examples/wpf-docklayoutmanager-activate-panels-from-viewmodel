...
'#End Region
    ...
    Public Class MainWindowViewModel
        ...
        Public ReadOnly Property AddNewTabCommand As ICommand
            Get
                If _AddNewTabCommand Is Nothing Then _AddNewTabCommand = New RelayCommand(New Action(Of Object)(AddressOf OnDocumentRequestAddNewTab))
        ...
        Private Sub OnDocumentRequestClose(ByVal sender As Object, ByVal e As EventArgs)
            ...
            If Documents.Count = 1 Then AddNewTab()
        ...
        Private Function CreateNewDocument() As DocumentViewModel
            Dim document As DocumentViewModel = New DocumentViewModel() With {.DisplayName = "Document" & count, .Content = "Content" & count}
            count += 1
            Return document
        End Function
    End Class
